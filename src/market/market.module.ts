...
@Module({
  imports: [TypeOrmModule.forFeature([MarketRepository, CategoryRepository, TagRepository,
    MarketShapeRepository, ExchangeRepository, GenreRepository, PartRepository, UserRepository, ProfileRepository, UserIp]), AuthModule],
  controllers: [MarketController],
  providers: [MarketService, S3UploadService, FileReaderService, ProfileService],
})
